...
{
    public class NumbersArgumentType<T> : IArgumentType<T[]> where T : struct, IComparable<T>
    {
        ...
        protected internal NumbersArgumentType(T? minimum, T? maximum, Func<IStringReader, T> readFunc, int argumentCount)
        {
        ...
        public override bool Equals(object? o) => o is NumbersArgumentType<T> arg && Equals(minimum, arg.minimum) && Equals(maximum, arg.maximum);
