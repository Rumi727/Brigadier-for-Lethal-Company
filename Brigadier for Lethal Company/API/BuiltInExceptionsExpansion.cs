...
#pragma warning disable IDE0060 // 사용하지 않는 매개 변수를 제거하세요.
        public static Dynamic2CommandExceptionType ColonTooMany(this IBuiltInExceptionProvider e) => new((found, max) => new LiteralMessage($"Number of colons must not be many than {max}, found {found}"));
